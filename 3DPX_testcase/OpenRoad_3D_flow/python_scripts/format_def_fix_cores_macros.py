  ...
  with open(input_file, 'r') as in_f, open(output_file, 'w') as out_f:
    ...
    for line in in_f:
      ...
      if parse_components == 1:
        ...
        elif "SOURCE TIMING" in line:
          parts = line.split()
          out_f.write(f"    {parts[0]} {parts[1]} {parts[2]} {parts[3]} {parts[4]} {parts[5]} {parts[6]} UNPLACED {parts[13]}\n")
          # print(f"    {parts[0]} {parts[1]} {parts[2]} {parts[3]} {parts[4]} {parts[5]} {parts[6]} UNPLACED {parts[13]}\n")
        else:
          parts = line.split()
          out_f.write(f"    {parts[0]} {parts[1]} {parts[2]} {parts[3]} UNPLACED {parts[10]}\n")
          # print(f"    {parts[0]} {parts[1]} {parts[2]} {parts[3]} UNPLACED {parts[10]}\n")
