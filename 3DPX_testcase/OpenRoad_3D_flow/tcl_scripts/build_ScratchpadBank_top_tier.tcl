...
source $data_path/Nangate45_3D_PDK_cores_creation_top_tier.vars
set design "ScratchpadBank"
set top_module "ScratchpadBank"
set sdc_file "../do_synth/results/ScratchpadBank.sdc"

read_def $outputs_path/ScratchpadBank_macro_placement_fixed.def
read_sdc $sdc_file
...
write_def $outputs_path/ScratchpadBank_post_place.def
write_verilog -remove_cells $filler_cells $outputs_path/ScratchpadBank_post_place.v
