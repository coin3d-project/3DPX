...
set design "TilePRCIDomain_core2"
set top_module "TilePRCIDomain_core2"
set sdc_file "../do_synth/results/TilePRCIDomain.sdc"

read_def $outputs_path/Core2_macro_placement_fixed.def
read_sdc $sdc_file
...
global_placement -density 0.7 -timing_driven -pad_left $global_place_pad -pad_right $global_place_pad -disable_revert_if_diverge
...
write_def $outputs_path/TilePRCIDomain_core2_post_place.def
write_verilog -remove_cells $filler_cells $outputs_path/TilePRCIDomain_core2_post_place.v
