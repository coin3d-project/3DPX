...
read_def $outputs_path/Core1_macro_placement_fixed.def
read_sdc $sdc_file
...
# IO Placement
set_io_pin_constraint -region right:* -region top:* -pin_names *
...
write_def $outputs_path/TilePRCIDomain_core1_post_place.def
write_verilog -remove_cells $filler_cells $outputs_path/TilePRCIDomain_core1_post_place.v
