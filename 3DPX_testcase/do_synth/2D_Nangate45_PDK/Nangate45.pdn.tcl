...
add_pdn_stripe -grid {grid} -layer {metal5} -width {0.8} -pitch {2.4} -offset {0} -followpins
add_pdn_stripe -grid {grid} -layer {metal6} -width {0.8} -pitch {100} -offset {0} 

add_pdn_ring -grid {grid} -layers {metal5 metal6} -spacings {1 1} -widths {4 4} -core_offsets {1 1}
