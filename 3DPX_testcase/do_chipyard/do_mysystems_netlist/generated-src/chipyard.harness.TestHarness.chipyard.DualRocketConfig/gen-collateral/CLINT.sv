...
module CLINT(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9]
  ...
  output        auto_int_out_1_1,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25]
  output        auto_int_out_0_0,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25]
  output        auto_int_out_0_1,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25]
  ...
  reg  [63:0]      pad_1;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:75:41]
  reg              ipi_0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:76:41]
  reg              ipi_1;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:76:41]
  ...
  wire [10:0]      _GEN = {auto_in_a_bits_address[15], auto_in_a_bits_address[13:4]};	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:192:34, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:75:19, :87:24]
  wire             _out_T_7 = _GEN == 11'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  wire             valids_2_0 = out_woready_19 & auto_in_a_bits_mask[0];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_2_1 = out_woready_19 & auto_in_a_bits_mask[1];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_2_2 = out_woready_19 & auto_in_a_bits_mask[2];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_2_3 = out_woready_19 & auto_in_a_bits_mask[3];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_2_4 = out_woready_19 & auto_in_a_bits_mask[4];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_2_5 = out_woready_19 & auto_in_a_bits_mask[5];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_2_6 = out_woready_19 & auto_in_a_bits_mask[6];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_2_7 = out_woready_19 & auto_in_a_bits_mask[7];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_0 = out_woready_27 & auto_in_a_bits_mask[0];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_1 = out_woready_27 & auto_in_a_bits_mask[1];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_2 = out_woready_27 & auto_in_a_bits_mask[2];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_3 = out_woready_27 & auto_in_a_bits_mask[3];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_4 = out_woready_27 & auto_in_a_bits_mask[4];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_5 = out_woready_27 & auto_in_a_bits_mask[5];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_6 = out_woready_27 & auto_in_a_bits_mask[6];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             valids_7 = out_woready_27 & auto_in_a_bits_mask[7];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [1:0]       out_oindex = {auto_in_a_bits_address[14], auto_in_a_bits_address[3]};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [1:0]       _GEN_0 = {auto_in_a_bits_address[14], auto_in_a_bits_address[3]};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  wire             out_woready_2 = _out_wofireMux_T_2 & _GEN_0 == 2'h0 & _out_T_7;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  assign out_woready_19 = _out_wofireMux_T_2 & _GEN_0 == 2'h1 & (&_GEN);	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  assign out_woready_27 = _out_wofireMux_T_2 & _GEN_0 == 2'h2 & _out_T_7;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  assign out_woready_9 = _out_wofireMux_T_2 & (&_GEN_0) & _out_T_7;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  wire [3:0]       _GEN_1 = {{_out_T_7}, {_out_T_7}, {&_GEN}, {_out_T_7}};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
  wire [3:0][63:0] _GEN_2 = {{pad_1}, {pad}, {time_0}, {{31'h0, ipi_1, 31'h0, ipi_0}}};	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:71:23, :75:41, :76:41, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9]
      ...
      ipi_1 <= 1'h0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:76:41]
    end
      ...
      if (out_woready_2 & auto_in_a_bits_mask[4])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
        ipi_1 <= auto_in_a_bits_data[32];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:76:41, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
    end
    ...
    if (valids_1_0 | valids_1_1 | valids_1_2 | valids_1_3 | valids_1_4 | valids_1_5 | valids_1_6 | valids_1_7)	// @[generators/rocket-chip/src/main/scala/regmapper/RegField.scala:154:27, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
      pad_1 <= {valids_1_7 ? auto_in_a_bits_data[63:56] : pad_1[63:56], valids_1_6 ? auto_in_a_bits_data[55:48] : pad_1[55:48], valids_1_5 ? auto_in_a_bits_data[47:40] : pad_1[47:40], valids_1_4 ? auto_in_a_bits_data[39:32] : pad_1[39:32], valids_1_3 ? auto_in_a_bits_data[31:24] : pad_1[31:24], valids_1_2 ? auto_in_a_bits_data[23:16] : pad_1[23:16], valids_1_1 ? auto_in_a_bits_data[15:8] : pad_1[15:8], valids_1_0 ? auto_in_a_bits_data[7:0] : pad_1[7:0]};	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:75:41, generators/rocket-chip/src/main/scala/regmapper/RegField.scala:151:57, :152:31, :154:52, :158:{20,33}, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9]
    ...
    logic [31:0] _RANDOM[0:6];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9]
    initial begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9]
        ...
        pad_1 = {_RANDOM[3'h4], _RANDOM[3'h5]};	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9, :75:41]
        ipi_0 = _RANDOM[3'h6][0];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9, :76:41]
        ipi_1 = _RANDOM[3'h6][1];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9, :76:41]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_int_out_1_0 = ipi_1;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9, :76:41]
  assign auto_int_out_1_1 = time_0 >= pad_1;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9, :71:23, :75:41, :81:43]
  assign auto_int_out_0_0 = ipi_0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9, :76:41]
  assign auto_int_out_0_1 = time_0 >= pad;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9, :71:23, :75:41, :81:43]
  ...
  assign auto_in_d_bits_data = _GEN_1[out_oindex] ? _GEN_2[out_oindex] : 64'h0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:64:9, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
endmodule
