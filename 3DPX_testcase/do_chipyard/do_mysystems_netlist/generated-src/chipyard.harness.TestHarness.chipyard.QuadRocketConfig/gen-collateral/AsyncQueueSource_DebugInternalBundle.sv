...
module AsyncQueueSource_DebugInternalBundle(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7]
  ...
  input        io_enq_bits_hasel,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  input        io_enq_bits_hamask_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  input        io_enq_bits_hamask_1,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  input        io_enq_bits_hamask_2,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  input        io_enq_bits_hamask_3,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  input        io_enq_bits_hrmask_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  input        io_enq_bits_hrmask_1,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  input        io_enq_bits_hrmask_2,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  input        io_enq_bits_hrmask_3,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  ...
  output       io_async_mem_0_hasel,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  output       io_async_mem_0_hamask_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  output       io_async_mem_0_hamask_1,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  output       io_async_mem_0_hamask_2,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  output       io_async_mem_0_hamask_3,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  output       io_async_mem_0_hrmask_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  output       io_async_mem_0_hrmask_1,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  output       io_async_mem_0_hrmask_2,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  output       io_async_mem_0_hrmask_3,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:73:14]
  ...
  reg        mem_0_hasel;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
  reg        mem_0_hamask_0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
  reg        mem_0_hamask_1;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
  reg        mem_0_hamask_2;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
  reg        mem_0_hamask_3;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
  reg        mem_0_hrmask_0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
  reg        mem_0_hrmask_1;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
  reg        mem_0_hrmask_2;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
  reg        mem_0_hrmask_3;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7]
    if (_widx_T_1) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
      ...
      mem_0_hasel <= io_enq_bits_hasel;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
      mem_0_hamask_0 <= io_enq_bits_hamask_0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
      mem_0_hamask_1 <= io_enq_bits_hamask_1;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
      mem_0_hamask_2 <= io_enq_bits_hamask_2;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
      mem_0_hamask_3 <= io_enq_bits_hamask_3;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
      mem_0_hrmask_0 <= io_enq_bits_hrmask_0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
      mem_0_hrmask_1 <= io_enq_bits_hrmask_1;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
      mem_0_hrmask_2 <= io_enq_bits_hrmask_2;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
      mem_0_hrmask_3 <= io_enq_bits_hrmask_3;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:82:16]
    end
  end // always @(posedge)
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7]
        ...
        mem_0_hasel = _RANDOM[/*Zero width*/ 1'b0][12];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
        mem_0_hamask_0 = _RANDOM[/*Zero width*/ 1'b0][13];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
        mem_0_hamask_1 = _RANDOM[/*Zero width*/ 1'b0][14];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
        mem_0_hamask_2 = _RANDOM[/*Zero width*/ 1'b0][15];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
        mem_0_hamask_3 = _RANDOM[/*Zero width*/ 1'b0][16];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
        mem_0_hrmask_0 = _RANDOM[/*Zero width*/ 1'b0][17];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
        mem_0_hrmask_1 = _RANDOM[/*Zero width*/ 1'b0][18];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
        mem_0_hrmask_2 = _RANDOM[/*Zero width*/ 1'b0][19];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
        mem_0_hrmask_3 = _RANDOM[/*Zero width*/ 1'b0][20];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
        widx_widx_bin = _RANDOM[/*Zero width*/ 1'b0][21];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :70:7, :82:16]
        ready_reg = _RANDOM[/*Zero width*/ 1'b0][22];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16, :90:56]
        widx_gray = _RANDOM[/*Zero width*/ 1'b0][23];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16, :93:55]
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7]
        widx_widx_bin = 1'h0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :70:7]
        ready_reg = 1'h0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :90:56]
  ...
  assign io_async_mem_0_hasel = mem_0_hasel;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
  assign io_async_mem_0_hamask_0 = mem_0_hamask_0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
  assign io_async_mem_0_hamask_1 = mem_0_hamask_1;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
  assign io_async_mem_0_hamask_2 = mem_0_hamask_2;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
  assign io_async_mem_0_hamask_3 = mem_0_hamask_3;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
  assign io_async_mem_0_hrmask_0 = mem_0_hrmask_0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
  assign io_async_mem_0_hrmask_1 = mem_0_hrmask_1;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
  assign io_async_mem_0_hrmask_2 = mem_0_hrmask_2;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
  assign io_async_mem_0_hrmask_3 = mem_0_hrmask_3;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:70:7, :82:16]
