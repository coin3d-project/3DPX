...
module JtagTapController(	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:59:7]
  ...
  output       io_jtag_TDO_driven,	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:62:14]
  ...
  reg        tdoeReg;	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:90:30]
  wire       irChain_io_chainIn_shift = _stateMachine_io_currState == 4'hA;	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:82:30, :104:41]
  ...
  always @(posedge clock_falling or posedge io_control_jtag_reset) begin	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:67:{33,48}]
    if (io_control_jtag_reset) begin	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:67:48]
      ...
      tdoeReg <= 1'h0;	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:59:7, :90:30]
      ...
      tdoeReg <= io_dataChainOut_shift_0 | irChain_io_chainIn_shift;	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:90:30, :104:41, :126:38, :134:44, :136:16, :137:51]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:59:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:59:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:59:7]
        ...
        tdoeReg = _RANDOM[/*Zero width*/ 1'b0][1];	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:59:7, :89:30, :90:30]
  ...
  CaptureUpdateChain_UInt5_To_UInt5 irChain (	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:102:23]
    .clock              (clock),
    .reset              (reset),
    .io_chainIn_shift   (irChain_io_chainIn_shift),	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:104:41]
  ...
  assign io_jtag_TDO_driven = tdoeReg;	// @[generators/rocket-chip/src/main/scala/jtag/JtagTap.scala:59:7, :90:30]
