...
source $data_path/Nangate45_2D_PDK.vars
...
initialize_floorplan -site $site -utilization 70 -aspect_ratio 1.5 -core_space 20
...
global_placement -routability_driven -timing_driven -density $global_place_density \
