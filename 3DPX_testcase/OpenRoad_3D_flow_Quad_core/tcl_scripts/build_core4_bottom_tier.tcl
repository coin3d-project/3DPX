...
set design "RocketTile_3"
set top_module "RocketTile_3"
set sdc_file "../do_synth/results/RocketTile.sdc"
read_def $outputs_path/Core4_macro_placement_fixed.def
read_sdc $sdc_file
...
# IO Placement
set_io_pin_constraint -region left:* -region bottom:* -pin_names *
...
write_def $outputs_path/Core4_post_place.def
write_verilog -remove_cells $filler_cells $outputs_path/Core4_post_place.v
