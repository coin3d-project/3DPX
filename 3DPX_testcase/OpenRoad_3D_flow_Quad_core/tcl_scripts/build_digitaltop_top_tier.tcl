...
set status [catch {global_placement -routability_driven -timing_driven -density 0.4 -pad_left $global_place_pad -pad_right $global_place_pad -disable_revert_if_diverge } err]
