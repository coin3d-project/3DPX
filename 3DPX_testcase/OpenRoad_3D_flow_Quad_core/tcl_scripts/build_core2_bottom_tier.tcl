...
set design "RocketTile_1"
set top_module "RocketTile_1"
...
# IO Placement
set_io_pin_constraint -region left:* -region top:* -pin_names *
...
write_def $outputs_path/Core2_post_place.def
write_verilog -remove_cells $filler_cells $outputs_path/Core2_post_place.v
